    ...
    return (
        <div className="a">
            ...
            <div className="a-right">
                ...
                <p className="a-desc">
                    I've always been a programming enthusiast. Through my years of experience, I've experimented with various diverse technologies and applied my skills in my projects.  For recreation, I do poetry. I love waking up to new horizons, connecting with people, and exploring the world.
                </p>
